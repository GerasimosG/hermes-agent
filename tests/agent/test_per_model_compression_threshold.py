...
overrides that are resolved by longest substring match. The small-context floor is not applied; each explicit override is used
as provided, while the default global ratio is 70%.
"""
